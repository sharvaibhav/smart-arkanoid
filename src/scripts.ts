...
let score1 = 0;
let score2 = 0;
let gameLogameLoopToggle : number = 0;

//create context
const canvas  = document.getElementById("context") as HTMLCanvasElement;
const canvasContext  = canvas.getContext("2d") as CanvasRenderingContext2D;
const scorePanel = document.querySelector(".score-panel > .score-container") as HTMLDivElement
const aceNumber = document.querySelector("#aceNumber") as HTMLInputElement
const ballSpeed =  document.querySelector("#ballsSpeed") as HTMLInputElement
